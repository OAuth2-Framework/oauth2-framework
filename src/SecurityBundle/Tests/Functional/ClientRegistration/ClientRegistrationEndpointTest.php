...
namespace OAuth2Framework\SecurityBundle\Tests\Functional\ClientRegistration;
...
class ClientRegistrationEndpointTest extends WebTestCase
{
    ...
    public function theInitialAccessTokenIsValidAndTheClientIsCreated()
    {
        ...
        $clientRepository = $container->get(\OAuth2Framework\SecurityBundle\Tests\TestBundle\Entity\ClientRepository::class);
