...
namespace OAuth2Framework\SecurityBundle\Tests\Functional\Revocation\AccessToken;
...
class RevocationEndpointTest extends WebTestCase
{
    ...
    public function aAccessTokenIsCorrectlyRevoked()
    {
        ...
        $accessTokenIdGenerator = $container->get(\OAuth2Framework\SecurityBundle\Tests\TestBundle\Entity\AccessTokenIdGenerator::class);
        ...
        $accessTokenRepository = $container->get(\OAuth2Framework\SecurityBundle\Tests\TestBundle\Entity\AccessTokenRepository::class);
