...
use OAuth2Framework\SecurityBundle\Model\ClientRepository;
use OAuth2Framework\Component\Endpoint\UserInfo\UserInfoEndpoint;
use OAuth2Framework\SecurityBundle\Middleware\OAuth2MessageMiddleware;
use OAuth2Framework\SecurityBundle\Middleware\OAuth2SecurityMiddleware;
use OAuth2Framework\SecurityBundle\Middleware\Pipe;
...
use OAuth2Framework\SecurityBundle\Middleware\FormPostBodyParserMiddleware;
