...
use OAuth2Framework\SecurityBundle\Controller\AuthorizationEndpointController;
use OAuth2Framework\SecurityBundle\Form\FormFactory;
use OAuth2Framework\SecurityBundle\Form\Handler\AuthorizationFormHandler;
use OAuth2Framework\SecurityBundle\Form\Type\AuthorizationType;
...
return function (ContainerConfigurator $container) {
    ...
    $container->set(\OAuth2Framework\SecurityBundle\Service\SymfonyUserDiscovery::class);
