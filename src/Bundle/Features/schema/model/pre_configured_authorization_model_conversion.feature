Feature: Models Conversion
  ...
  Scenario: Pre-Configured Authorization Object can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Model\PreConfiguredAuthorization\PreConfiguredAuthorization"
