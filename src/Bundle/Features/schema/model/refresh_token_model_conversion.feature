Feature: Models Conversion
  ...
  Scenario: Access Token Object can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Model\AccessToken\AccessToken"

  Scenario: Refresh Token Object can be converted and recovered
    Given I have an Refresh Token Object
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Model\RefreshToken\RefreshToken"
