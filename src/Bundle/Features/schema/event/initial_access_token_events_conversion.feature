Feature: Event Objects Conversion
  ...
  Scenario: Initial Access Token Created Event can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\InitialAccessToken\InitialAccessTokenCreatedEvent"
  ...
  Scenario: Initial Access Token Revoked Event can be converted and recovered
    ...
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\InitialAccessToken\InitialAccessTokenRevokedEvent"
