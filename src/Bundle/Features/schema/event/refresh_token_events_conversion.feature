Feature: Event Objects Conversion
  ...
  Scenario: Refresh Token Created Event can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\RefreshToken\RefreshTokenCreatedEvent"
  ...
  Scenario: Access Token Added To Refresh Token Event can be converted and recovered
    ...
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\RefreshToken\AccessTokenAddedToRefreshTokenEvent"
  ...
  Scenario: Refresh Token Revoked Event can be converted and recovered
    ...
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\RefreshToken\RefreshTokenRevokedEvent"
