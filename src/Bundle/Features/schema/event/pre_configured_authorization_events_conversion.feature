Feature: Event Objects Conversion
  ...
  Scenario: Pre-Configured Authorization Created Event can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\PreConfiguredAuthorization\PreConfiguredAuthorizationCreatedEvent"
  ...
  Scenario: Pre-Configured Authorization Revoked Event can be converted and recovered
    ...
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\PreConfiguredAuthorization\PreConfiguredAuthorizationRevokedEvent"
