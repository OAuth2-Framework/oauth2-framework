Feature: Event Objects Conversion
  ...
  Scenario: Client Created Event can be converted and recovered
    ...
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\Client\ClientCreatedEvent"

  Scenario: Client Owner Changed Event can be converted and recovered
    Given I have a valid Client Owner Changed Event object
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\Client\ClientOwnerChangedEvent"
  ...
  Scenario: Client Parameters Updated Event can be converted and recovered
    ...
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\Client\ClientParametersUpdatedEvent"

  Scenario: Client Deleted Event can be converted and recovered
    Given I have a valid Client Deleted Event object
    When I convert the Domain Object into a Json Object
    Then I can recover the event from the Json Object and its class is "OAuth2Framework\Component\Event\Client\ClientDeletedEvent"
