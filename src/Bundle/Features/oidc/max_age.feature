Feature: A client requests an authorization
  ...
  Scenario: A client sends an authorization request with a max_age parameter. The user has to authenticate again
  ...
  Scenario: A client sends an authorization request with a max_age parameter. The user does not need to authenticate again
    Given The user "john.1" is logged in and fully authenticated
