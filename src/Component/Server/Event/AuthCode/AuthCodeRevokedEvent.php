...
final class AuthCodeRevokedEvent extends Event
{
    ...
    {
        return 'https://oauth2-framework.spomky-labs.com/schemas/events/auth-code/revoked/1.0/schema';
    }
     ...
     */
    public static function create(AuthCodeId $authCodeId): AuthCodeRevokedEvent
    {
