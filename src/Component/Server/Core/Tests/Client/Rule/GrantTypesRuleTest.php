...
final class GrantTypesRuleTest extends TestCase
{
    ...
    /**
     * @var null|Rule\GrantTypesRule
     */
    private $grantTypesRule = null;

    /**
     * @return Rule\GrantTypesRule
     */
    private function getGrantTypesRule(): Rule\GrantTypesRule
    {
        if (null == $this->grantTypesRule) {
            ...
            $this->grantTypesRule = new Rule\GrantTypesRule(
                $grantTypeManager
            );
        }
