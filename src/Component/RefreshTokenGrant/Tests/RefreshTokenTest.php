...
class RefreshTokenTest extends TestCase
{
    ...
    {
        $events = [
            '{"$schema":"https://oauth2-framework.spomky-labs.com/schemas/events/refresh-token/created/1.0/schema","event_id":"f29c3cf9-7630-4d0c-861e-9005d0e33c61","type":"OAuth2Framework\\\\Component\\\\RefreshTokenGrant\\\\Event\\\\RefreshTokenCreatedEvent","domain_id":"REFRESH_TOKEN_ID","recorded_on":1512893793,"payload":{"resource_owner_id":"CLIENT_ID","resource_owner_class":"OAuth2Framework\\\\Component\\\\Core\\\\Client\\\\ClientId","client_id":"CLIENT_ID","parameters":{"refresh_token_id":"REFRESH_TOKEN_ID"},"expires_at":1264683600,"metadatas":{},"resource_server_id":"RESOURCE_SERVER_ID"}}',
            '{"$schema":"https://oauth2-framework.spomky-labs.com/schemas/events/refresh-token/access-token-added/1.0/schema","event_id":"b0316425-4d7f-4b4d-8882-78a80daf4bde","type":"OAuth2Framework\\\\Component\\\\RefreshTokenGrant\\\\Event\\\\AccessTokenAddedToRefreshTokenEvent","domain_id":"REFRESH_TOKEN_ID","recorded_on":1512893793,"payload":{"access_token_id":"ACCESS_TOKEN_ID"}}',
            '{"$schema":"https://oauth2-framework.spomky-labs.com/schemas/events/refresh-token/revoked/1.0/schema","event_id":"625a79ec-cfd7-4a9c-9b19-b90f7a0ccafa","type":"OAuth2Framework\\\\Component\\\\RefreshTokenGrant\\\\Event\\\\RefreshTokenRevokedEvent","domain_id":"REFRESH_TOKEN_ID","recorded_on":1512893793}',
        ];
        $refreshToken = RefreshToken::createEmpty();
